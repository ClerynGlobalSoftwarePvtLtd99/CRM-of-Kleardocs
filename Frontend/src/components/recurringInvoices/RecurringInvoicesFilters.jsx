...
const RecurringInvoicesFilters = ({
  ...
  return (
    <div className="bg-bg-secondary border border-bg-tertiary p-4 rounded-xl mb-6">
      <div className="flex flex-col xl:flex-row items-start xl:items-center gap-4 w-full">
        ...
        <div className="relative min-w-[200px] flex-1 w-full xl:w-auto">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-bg-primary border border-bg-tertiary rounded-lg focus:outline-none focus:border-accent transition-colors text-text-primary text-sm"
          />
        </div>
        ...
        <div className="relative w-full xl:w-auto shrink-0">
          <select
            ...
            className="w-full xl:w-auto appearance-none pl-4 pr-10 py-2 bg-bg-primary border border-bg-tertiary rounded-lg focus:outline-none focus:border-accent transition-colors text-text-primary cursor-pointer min-w-[130px] text-sm"
          >
        ...
        <div className="relative w-full xl:w-auto shrink-0">
          <select
            ...
            className="w-full xl:w-auto appearance-none pl-4 pr-10 py-2 bg-bg-primary border border-bg-tertiary rounded-lg focus:outline-none focus:border-accent transition-colors text-text-primary cursor-pointer min-w-[120px] text-sm"
          >
