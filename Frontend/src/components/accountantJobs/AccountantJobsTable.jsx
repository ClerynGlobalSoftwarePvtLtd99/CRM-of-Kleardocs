        ...
        <table className="w-full text-left relative" style={{ borderSpacing: '0 10px', borderCollapse: 'separate' }}>
          <thead>
            <tr className="text-[var(--color-text-secondary)] text-sm uppercase tracking-wider">
              ...
              <th className="sticky top-0 z-20 bg-[var(--color-bg-secondary)] px-1.5 py-3 font-medium whitespace-nowrap shadow-[0_1px_0_var(--color-bg-tertiary)]">Job Name</th>
              <th className="sticky top-0 z-20 bg-[var(--color-bg-secondary)] px-1.5 py-3 font-medium shadow-[0_1px_0_var(--color-bg-tertiary)]">Customer</th>
          ...
          <tbody>
            {jobs.map((job) => (
              <tr key={job.id} className="bg-[var(--color-bg-primary)] hover:bg-[var(--color-bg-tertiary)] transition-colors group rounded-md shadow-sm">
                <td className="px-1.5 py-3 text-sm rounded-l-lg">{job.created}</td>
                <td className="px-1.5 py-3 font-medium text-sm">{job.jobName}</td>
                <td className="px-1.5 py-3">
                  <div className="flex flex-col">
                    <a href={job.customerLink} className="text-blue-500 hover:underline text-sm font-medium">{job.customer}</a>
                ...
                <td className="px-1.5 py-3 text-sm whitespace-nowrap">{job.expiry}</td>
                <td className="px-1.5 py-3">
                ...
                <td className="px-1.5 py-3 text-sm whitespace-nowrap">{job.completedDate || '-'}</td>
